...
async function package2func(){
   ...
   p11.textContent=`${data[10][2]}`;
   p12.textContent=`${data[11][2]}`;
...
console.log(data[0][0]);
    ...
    h11.textContent=`${data[10][0]}`;
    h12.textContent=`${data[11][0]}`;
    ...
    id11.textContent=`${data[10][1]}`;
    localStorage.setItem('package_id11',data[10][1] );

    id12.textContent=`${data[11][1]}`;
    localStorage.setItem('package_id12',data[11][1] );
...
function view11(){
    localStorage.setItem('package_id',localStorage.getItem('package_id11') );
}
function view12(){
    localStorage.setItem('package_id',localStorage.getItem('package_id12') );
}